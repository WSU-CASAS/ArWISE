"""
mae_test.py --datafile <data_file> --modelfile <model_file>
...
based on a pretrained model. This is the third of three steps that are: 1) pretrain (mae_pretrain.py),
...
def evaluate_model(classification_model, X, y):
...
if __name__ == "__main__":
    ...
    evaluate_model(classification_model, X, y)
